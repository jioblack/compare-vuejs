    	...
    	<div class="container">
    		<div class="columns pd is-desktop">
    			...
    			<div class="column is-one-third-desktop">
    				<p class="title"><strong>We provide superior logistics so that your business can succeed in this crazy world.</strong></p>
    			</div>
    			<div class="column">
...
export default {
  ...
  data() {
  	return{
  		...
  		subheading: 'Lorem ipsum dolor sit, amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut abore et dolore magna aliqua.'
  	}
  }
